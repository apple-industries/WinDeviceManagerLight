...
namespace HardwareHelperLib
{
    ...
    public class Native
    {
        ...
        [DllImport(_setupapidll, SetLastError = true)]
        ...
        [DllImport(_setupapidll, SetLastError = true, CharSet = CharSet.Auto)]
    ...
    public class HH_Lib
    {
        ...
        public List<DEVICE_INFO> GetAll()
        {
            ...
            try
            {
                ...
                for (i = 0; Native.SetupDiEnumDeviceInfo(hDevInfo, i, DeviceInfoData); i++)
                {
                    ...
                    if (Native.CM_Get_DevNode_Status(out uint status, out uint problem, DeviceInfoData.devInst, 0) == Native.CR_SUCCESS)
        ...
        public void CutLooseHardwareNotifications(IntPtr callback)
        {
            ...
            {
                //Just being extra cautious since the code is unmanaged
            }
        }
        #endregion
